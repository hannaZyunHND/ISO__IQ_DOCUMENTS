...
```mermaid
graph TD
    A[2 tuần trước] --> B[Lập kịch bản]
    B --> C[Thành lập Ban chỉ đạo]
    C --> D[Chuẩn bị thiết bị]
    D --> E[Thông báo toàn trường]
    
    E --> F[Ngày diễn tập]
    F --> G[Phát tín hiệu cháy]
    G --> H[Báo động toàn trường]
    
    H --> I[Học sinh sơ tán]
    I --> J[Ra điểm tập trung]
    J --> K[Điểm danh]
    K --> L{Đủ người?}
    
    L -->|Thiếu| M[Đội cứu hộ tìm kiếm]
    L -->|Đủ| N[Báo cáo an toàn]
    M --> N
    
    N --> O[Đội dập cháy hoạt động]
    O --> P[Xe cứu hỏa đến]
    P --> Q[Phối hợp dập cháy]
    
    Q --> R[Tuyên bố hết cháy]
    R --> S[Đánh giá]
    S --> T[Nhận xét]
    T --> U[Rút kinh nghiệm]
    U --> V[Báo cáo, lưu trữ]
