...
```mermaid
graph TD
    A[Thứ 2: Họp lên ý tưởng] --> B[Team brainstorm nội dung tuần sau]
    B --> C[Ghi vào Trello: 3 Post FB, 2 Blog, 1 Video...]
    
    C --> D[Trưởng BP duyệt ý tưởng]
    D --> E{OK?}
    E -->|Sửa| F[Điều chỉnh ý tưởng]
    F --> D
    E -->|OK| G[Phân công]
    
    G --> H[NV A: Post 1, Blog 1]
    G --> I[NV B: Post 2, Video]
    G --> J[NV C: Post 3, Blog 2]
    
    H --> K[Trong tuần: Sản xuất]
    I --> K
    J --> K
    
    K --> L[Chụp ảnh, Viết caption, Thiết kế...]
    L --> M[Tuân thủ Brand Guidelines]
    M --> N[Kiểm tra chính tả Grammarly]
    
    N --> O[Thứ 6 15h: Nộp để duyệt]
    O --> P[Trưởng BP xem tất cả]
    P --> Q[Checklist: Logo? Màu? Chính tả? Hấp dẫn?]
    
    Q --> R{Đạt?}
    R -->|Không| S[Sửa lại - Nộp lại]
    S --> P
    R -->|Có| T[Duyệt! ✅]
    ...
    W --> X[Like, Comment, Share, Reach...]
    X --> Y{Tốt?}
    Y -->|Không| Z[Phân tích: Tại sao? Ảnh xấu? Caption dài?]
    Y -->|Có| AA[Học hỏi: Làm nhiều loại này!]
    
    Z --> AB[Tuần sau: Cải thiện]
    AA --> AB
    AB --> A
```
