...
```mermaid
graph TD
    A[Quản lý 6 kênh Online + 3 Offline] --> B[WEBSITE: 2 blog/tuần]
    A --> C[FACEBOOK PAGE: 3-5 post/tuần]
    A --> D[FACEBOOK GROUP: Duyệt bài 2 lần/ngày]
    A --> E[INSTAGRAM: 3 post + 2 story/ngày + 1 reel/tuần]
    A --> F[YOUTUBE: 1-2 video/tháng]
    A --> G[ZALO OA: Trả lời ≤5 phút]
    
    B --> H[SEO: Tối ưu từ khóa, Backlink...]
    B --> I[Bảo trì: Backup, Update hằng tháng]
    
    C --> J[Đăng theo Content Calendar]
    J --> K[Trả lời comment trong 2h]
    K --> L[Xử lý crisis nếu có]
    
    D --> M[Admin duyệt thành viên mới]
    D --> N[Mod giúp duyệt bài, Trả lời]
    D --> O[Xử lý vi phạm: Nhắc → Cảnh cáo → Kick]
    
    E --> P[Ảnh đẹp: Ánh sáng tự nhiên, Filter tươi]
    E --> Q[Reels: Trending music, 15-30s]
    E --> R[Tăng followers: Giveaway, Collab Influencer]
    
    F --> S[Quay video chất lượng: 1080p, Ánh sáng tốt]
    F --> T[Edit: Subtitle, Nhạc nền...]
    F --> U[Upload: Thumbnail đẹp, Description có SEO]
    
    L --> V[Theo dõi KPI hằng tuần]
    V --> W[Facebook: Engagement ≥3%?]
    V --> X[Website: Traffic 15K/tháng?]
    V --> Y[Instagram: Engagement ≥5%?]
    
    W --> Z{Đạt?}
    X --> Z
    Y --> Z
    
    Z -->|Không| AA[Phân tích: Nội dung nhàm? Giờ đăng sai?]
    Z -->|Có| AB[Tiếp tục duy trì]
    
    AA --> AC[Cải thiện: Nội dung tốt hơn, Giờ đăng tốt hơn]
    AC --> A
    AB --> A
```
