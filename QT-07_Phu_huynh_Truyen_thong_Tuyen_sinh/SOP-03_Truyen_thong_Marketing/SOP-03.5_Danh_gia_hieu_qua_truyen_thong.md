...
```mermaid
graph TD
    A[Mỗi ngày 9h: Theo dõi] --> B[Mở Dashboard Google Data Studio]
    B --> C[Kiểm tra KPI hôm qua: Cost/Lead, Traffic, Engagement...]
    C --> D{Đạt mục tiêu?}
    
    D -->|Có| E[Tiếp tục ✅]
    D -->|Không| F[Phân tích: Tại sao?]
    
    F --> G[Ad nào kém? Kênh nào kém?]
    G --> H[Hành động: Tắt Ad kém, Tăng Ad tốt]
    H --> I[Ghi nhận: Google Sheet]
    
    E --> J[Cuối tuần: Báo cáo tuần QT07-BC08]
    I --> J
    
    J --> K[Tổng hợp: Lead, Cost, Thành công, Thất bại...]
    K --> L[Trình Trưởng BP TT]
    L --> M[Họp review: Tuần sau làm gì?]
    
    M --> N[Cuối tháng: Báo cáo tháng QT07-BC09]
    N --> O[Phân tích sâu: Funnel, Demographics, So sánh tháng trước...]
    O --> P[Trình BGH]
    P --> Q[BGH duyệt, Điều chỉnh chiến lược]
    
    Q --> R[Cuối năm: Báo cáo năm QT07-BC10]
    R --> S[Tổng kết toàn diện: Thành công, Thất bại, Bài học...]
    S --> T[Đề xuất kế hoạch năm sau]
    T --> U[BGH duyệt]
    U --> V[✅ Bắt đầu chu kỳ mới!]
```
