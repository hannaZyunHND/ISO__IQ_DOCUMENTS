...
```mermaid
graph TD
    A[Tháng 2: Lập kế hoạch chiến dịch] --> B[Mục tiêu, Ngân sách, Timeline...]
    B --> C[Tuần 3-4: Chuẩn bị]
    C --> D[Thiết kế Creative: Poster, Ad, Video...]
    C --> E[Viết Copy: Facebook, Google, Email...]
    C --> F[Setup Ads: Facebook Manager, Google Ads...]
    ...
    G --> H[00:01: Bật Ads]
    G --> I[09:00: Facebook Post organic]
    G --> J[10:00: Email Database]
    G --> K[14:00: Press Release]
    
    H --> L[Theo dõi mỗi ngày 9h]
    I --> L
    J --> L
    K --> L
    
    L --> M[Kiểm tra: Cost/Lead, Lead mới, Reach...]
    M --> N{Đạt KPI?}
    
    N -->|Không| O[Phân tích: Tại sao?]
    O --> P{Nguyên nhân?}
    P -->|Cost cao| Q[Tắt Ad kém, Tăng Ad tốt]
    P -->|Lead ít| R[Tăng Budget, Mở rộng Target]
    P -->|Conversion thấp| S[Cải thiện Landing page, Follow-up tốt hơn]
    ...
    L --> V[Mỗi tuần: Họp review]
    V --> W[Tuần trước: Đạt gì? Thiếu gì?]
    W --> X[Tuần này: Làm gì?]
    X --> L
    
    L --> Y[30/06: Kết thúc chiến dịch]
    Y --> Z[05/07: Báo cáo tổng kết]
    Z --> AA[Phân tích: Lead, Cost, ROI, Kênh...]
    AA --> AB[Thành công? Thất bại? Bài học?]
    AB --> AC[Khuyến nghị năm sau]
    AC --> AD[✅ Hoàn thành chiến dịch!]
```
