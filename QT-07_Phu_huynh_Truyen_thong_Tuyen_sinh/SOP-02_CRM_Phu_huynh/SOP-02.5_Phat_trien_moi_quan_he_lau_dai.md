...
```mermaid
graph TD
    A[NĂM 1-2: PH MỚI - Làm quen] --> B[Chào đón ấm áp: Welcome kit]
    B --> C[Hỗ trợ tối đa: Giải đáp, Hướng dẫn]
    C --> D[Theo dõi sát: GVCN gọi mỗi tuần]
    D --> E[Ưu đãi: Giảm 5% năm 2]
    E --> F{PH có hài lòng?}
    F -->|Không| G[Xử lý: Tìm hiểu, Giải quyết]
    F -->|Có| H[GIỮ CHÂN THÀNH CÔNG! ✅]
    
    H --> I[NĂM 3-5: PHÁT TRIỂN]
    I --> J[Giới thiệu dịch vụ thêm: Xe, Ăn, Học thêm...]
    J --> K[Khuyến khích anh chị em: Giảm 10% con 2]
    K --> L[Tạo cộng đồng: Sự kiện, Nhóm Facebook...]
    L --> M[Nâng cấp VIP nếu đủ điều kiện]
    
    M --> N[NĂM 6-9: TRUNG THÀNH]
    N --> O[Tri ân: Quà tặng, VIP event...]
    O --> P[Yêu cầu giới thiệu: Referral program]
    P --> Q{PH có giới thiệu?}
    Q -->|Có| R[Thưởng: Giảm 5% + 300 điểm]
    Q -->|Không| S[Động viên tiếp]
    
    R --> T[Mời làm Brand Ambassador]
    T --> U[PH đại diện trường: Review, Chia sẻ...]
    
    U --> V[NĂM 9+: TỐT NGHIỆP]
    V --> W[Lễ tốt nghiệp ấn tượng]
    W --> X[Tặng Alumni Card vĩnh viễn]
    X --> Y[Mời tham gia Alumni Network]
    
    Y --> Z[Alumni về thăm trường 1 năm/lần]
    Z --> AA[Alumni giới thiệu PH mới]
    Z --> AB[Alumni cho con học lại - Thế hệ 2!]
    
    AB --> AC[CHU KỲ BẮT ĐẦU LẠI! 🔄]
    AC --> A
    
    L --> AD[Loyalty Program: Tích điểm]
    AD --> AE[Đồng → Bạc → Vàng → Kim cương]
    AE --> AF[Quyền lợi tăng dần: Giảm giá, Ưu tiên...]
    
    P --> AG[Referral Program]
    AG --> AH[PH cũ giới thiệu → Cả 2 giảm 5%]
    AH --> AI[Leaderboard: Top 3 giới thiệu nhiều nhất]
```
