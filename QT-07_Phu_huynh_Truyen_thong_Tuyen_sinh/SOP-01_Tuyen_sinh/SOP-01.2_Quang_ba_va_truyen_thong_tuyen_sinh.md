...
```mermaid
graph TD
    A[Tuần 1 Tháng 3: Chuẩn bị] --> B[Thiết kế Creative: Ảnh, Video, Copy]
    B --> C[Duyệt nội dung: BGH kiểm tra]
    C --> D{OK?}
    D -->|Sửa| E[Chỉnh sửa]
    E --> C
    
    D -->|OK| F[Tuần 2: Setup Campaign]
    F --> G[Facebook Ads: Target, Budget, Placement]
    F --> H[Google Ads: Keywords, Ad copy]
    F --> I[Poster: Thiết kế, In 500 tờ]
    F --> J[PR: Viết thông cáo, Gửi 20 báo]
    
    G --> K[Tuần 3-4: Triển khai]
    H --> K
    I --> K
    J --> K
    
    K --> L[Facebook: Chạy Ads 2.5M/ngày]
    K --> M[Google: Chạy Search Ads]
    K --> N[Poster: Treo 50 chung cư, 10 siêu thị...]
    K --> O[PR: Follow-up báo, Mời phóng vấn]
    
    L --> P[Mỗi ngày: Tối ưu]
    M --> P
    P --> Q[Kiểm tra: Cost/Lead, Conversion]
    Q --> R{Đạt KPI?}
    R -->|Không| S[Điều chỉnh: Đổi ảnh, Copy, Target]
    S --> P
    R -->|Có| T[Tiếp tục]
    
    T --> U[Tháng 4-5: Cao điểm]
    U --> V[Tăng Budget: 2.5M → 3M/ngày]
    V --> W[Chạy thêm: Instagram, TikTok]
    W --> X[Tổ chức 3 Sự kiện tư vấn]
    
    X --> Y[Mỗi sự kiện]
    Y --> Z[Chuẩn bị 3 tuần: Trang trí, Quà, Nhân sự]
    Z --> AA[Quảng bá: Facebook Event, Email, SMS]
    AA --> AB[Ngày G: Đón tiếp, Giới thiệu, Tham quan, Tư vấn]
    AB --> AC[Sau 1-3 ngày: Follow-up PH]
    
    AC --> AD[Tháng 6-8: Thu hẹp]
    AD --> AE[Giảm Budget, Tập trung Lead chất lượng]
    
    AE --> AF[Cuối tháng 8: Tổng kết]
    AF --> AG[Đạt 150 HS? So với chỉ tiêu?]
    AG --> AH[Phân tích: Kênh nào hiệu quả? ROI?]
    AH --> AI[Bài học kinh nghiệm cho năm sau]
    AI --> AJ[✅ Hoàn thành tuyển sinh!]
```
