...
```mermaid
graph TD
    A[PH đến nộp giấy gốc] --> B[NV tiếp đón, Kiểm tra mã HS]
    B --> C[Kiểm tra giấy tờ: Checklist 15 điểm]
    C --> D{Đầy đủ?}
    D -->|Thiếu| E[Yêu cầu bổ sung, Hẹn ngày]
    E --> F[PH về bổ sung]
    F --> A
    
    D -->|Đủ| G[Kiểm tra từng loại chi tiết]
    G --> H[Giấy khai sinh: Gốc? Tên khớp? Ngày khớp?]
    H --> I[Sổ HK: Có tên HS? Địa chỉ rõ?]
    I --> J[Học bạ: Gốc? Dấu trường cũ? Điểm rõ?]
    J --> K[Phiếu SK: < 6 tháng? Dấu BV? KL đủ SK?]
    K --> L[Sổ tiêm: Đủ mũi? Còn thiếu?]
    L --> M[Ảnh: Đủ 6? Phông trắng/xanh?]
    
    M --> N{Tất cả OK?}
    N -->|Có vấn đề| O[Giải thích PH, Yêu cầu sửa]
    O --> E
    
    N -->|OK| P[Photo/Scan tất cả]
    P --> Q[Lưu vào Server: Thư mục HS]
    Q --> R[Trả giấy gốc cho PH]
    R --> S[Giữ lại: Học bạ gốc]
    
    S --> T[Tạo bìa hồ sơ giấy]
    T --> U[Ghi: Tên, Mã, Lớp, GVCN]
    U --> V[Sắp xếp 15 giấy tờ đúng thứ tự]
    V --> W[Bỏ vào bìa, Đóng dấu kiểm tra]
    W --> X[Xếp vào tủ: Theo lớp, ABC]
    
    X --> Y[Nhập thông tin vào Phần mềm]
    Y --> Z[Thông tin cơ bản: Tên, Ngày sinh, PH, Địa chỉ...]
    Z --> AA[Upload ảnh HS]
    AA --> AB[Phân lớp: 1A, GVCN Nguyễn Thị X]
    AB --> AC[Tạo tài khoản PH xem điểm]
    
    AC --> AD[In Thẻ HS]
    AD --> AE[Thiết kế: Ảnh + Thông tin + Barcode]
    AE --> AF[In, Ép plastic]
    AF --> AG[Phát cho HS ngày khai giảng]
    
    AG --> AH[Trước KG 1 tuần: Rà soát tổng thể]
    AH --> AI[Checklist: Giấy đủ? Số đủ? Thẻ đã in?]
    AI --> AJ{100% HS OK?}
    AJ -->|Chưa| AK[Xử lý HS thiếu sót]
    AJ -->|OK| AL[✅ Sẵn sàng khai giảng!]
```
