...
```mermaid
graph TD
    A[1 tuần trước: Chuẩn bị] --> B[NV: Danh sách, Phiếu điểm danh]
    B --> C[GVCN: Dọn lớp, Trang trí, Chuẩn bị đồ]
    C --> D[IT: Video, Slide, Loa, Máy chiếu]
    D --> E[Y tế: Sẵn sàng xử lý]
    E --> F[Gửi thông báo PH: 3 ngày trước]
    
    F --> G[Ngày Orientation: 08:45]
    G --> H[NV đón tại cổng]
    H --> I[Kiểm tra danh sách, Phát sticker tên]
    I --> J[Hướng dẫn vào hội trường, Ngồi theo lớp]
    
    J --> K[09:00: Chào đón]
    K --> L[HT phát biểu chào mừng]
    L --> M[Chiếu video giới thiệu trường]
    M --> N[Giới thiệu GVCN từng lớp]
    
    N --> O[09:30: Tham quan]
    O --> P[GVCN dẫn HS+PH đi]
    P --> Q[Cổng → Sân → Lớp → WC → Thư viện → Y tế → Bếp → Về lớp]
    
    Q --> R[10:00: Làm quen]
    R --> S[HS ngồi theo nhóm 4-6]
    S --> T[Game: Tự giới thiệu]
    T --> U[Làm Name tag]
    U --> V[Game: Tìm bạn cùng sở thích]
    
    V --> W[10:30: Hướng dẫn quy định]
    W --> X[Giờ học, Giờ nghỉ]
    X --> Y[Quy tắc lớp: Giơ tay, Không đánh bạn...]
    Y --> Z[Đồng phục, Ăn uống, Đi vệ sinh]
    Z --> AA[PH hỏi đáp]
    
    AA --> AB[11:00: Phát đồ dùng]
    AB --> AC[Gọi tên từng HS]
    AC --> AD[Trao: Thẻ, Sổ, Túi, Quà]
    AD --> AE[Hướng dẫn Sổ liên lạc]
    
    AE --> AF[Chụp ảnh lưu niệm]
    AF --> AG[GVCN kết thúc, Tạm biệt]
    AG --> AH[✅ Sẵn sàng khai giảng!]
```
